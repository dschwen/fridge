var app = require('http').createServer(handler)
  ...
  , words = [ 'face','head','pipe','computer','server','screen','link','knowledge',
              ...
              'envy','passion','love','ski','outdoors','hole','light','contact',
              'save','leave','picture','fire','rain','solution',
              'fresh', 'full', 'burst','delicious','trouser','snake',
              'he','she','it','me','I','I','you','your','then','if',
              ...
              'interactive', 'sun','meadow','pie','tree','ice','cream',
              'ing','ing','es','s','s','y',
              'one','good','bad','evil','why','when','how','what','who','where',
